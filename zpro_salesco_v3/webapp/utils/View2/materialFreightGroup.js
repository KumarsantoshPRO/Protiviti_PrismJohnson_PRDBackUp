    ...
    return {
      ...
      onMaterialFreightGroupsHelp: function (oEvent, that) {
        ...
        if (Division) {
          that
            .byId(
              sap.ui.core.Fragment.createId("idV2FragGenInfo", "idV2SLVertical")
            )
            .setValueState("None");

          that.bindingContextPath = oEvent
            .getSource()
            .getParent()
            .getBindingContextPath();
          var oResourceModel = that
            .getView()
            .getModel("i18nV2")
            .getResourceBundle();

          if (!that.oFragment) {
            that.oFragment = sap.ui.xmlfragment(
              "zpj.pro.sk.sd.salescoordinator.zprosalesco.view.fragments.View2.F4s.materialFreightGroupsF4",
              that
            );
            that.oFragment.setTitle(
              oResourceModel.getText("view2.F4.title.materialFreightGroups")
            );
            that.getView().addDependent(that.SalesOfficerag);
            that._SalesOfficeTemp = sap.ui
              .getCore()
              .byId("idSLMaterialFreightGroupsValueHelp")
              .clone();
            that._oTempMaterialFreightGroups = sap.ui
              .getCore()
              .byId("idSLMaterialFreightGroupsValueHelp")
              .clone();
          }
          var aFilter = [];
          var oFilterDomname = new sap.ui.model.Filter(
            [
          ...
          var oFilterDomname1 = new sap.ui.model.Filter(
            [
              new sap.ui.model.Filter(
                "Domname1",
                sap.ui.model.FilterOperator.EQ,
          ...
          sap.ui
            .getCore()
            .byId("idSDMaterialFreightGroupsF4")
      ...
      onMaterialFreightGroupsHelpConfirm: function (oEvent, that) {
        ...
        var sPart = that
          .getView()
          .getModel("JSONModelPayload")
          .getProperty(bindingContextPathPart);
        var sManufacturingPlant = that
          .getView()
          .getModel("JSONModelPayload")
          .getProperty(bindingContextPathMFP);
        var sSelectedValueQuality = that
          .getView()
          .getModel("JSONModelPayload")
          .getProperty(bindingContextPathQuality);
        ...
        for (var i = 0; i < aModelData.length; i++) {
          if (
            ...
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathMFG, "");
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathSize, "");
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathMFP, "");
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathPart, "");
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathQuality, "");
            i = aModelData.length;
          } else {
            that
              .getView()
              .getModel("JSONModelPayload")
              .setProperty(bindingContextPathMFG, sSelectedValue);
            var aFilter = [];
            var oFilterDomname = new sap.ui.model.Filter(
              [
                new sap.ui.model.Filter(
              ...
              .read(sPath, {
                ...
                success: function (Data) {
                  ...
                  that
                    ...
                    .getModel("JSONModelPayload")
                    .setProperty(
                      bindingContextPathSize,
                      Data.results[0].Ddtext
                    );
                }.bind(that),
            ...
            .read(sPath, {
              ...
              success: function (Data) {
                if (Data.results.length > 0) {
                  ...
                  that
                    .getView()
                    .setModel(JSONModelForSuggest, "JSONModelForSuggest");
          ...
          if (
            ...
            if (
              that
                .getView()
                .getModel("JSONModelPayload")
                .getProperty(bindingContextPathMFG) !== ""
            ) {
              MessageBox.error(
                "Material Freigth Group:- '" +
                  sSelectedValue +
                    ...
                    if (Data.results.length === 1) {
                      if (sValue1.includes("Mvgr2")) {
                        that
                          .getView()
                          .getModel("JSONModelPayload")
                          .setProperty(sValue1, Data.results[0].Ddtext);
                      } else {
                        that
                          .getView()
                          .getModel("JSONModelPayload")
                          .setProperty(sValue1, Data.results[0].DomvalueL);
                      }
                      if (sValue2) {
                        that
                          .getView()
                          .getModel("JSONModelPayload")
                          .setProperty(sValue2, Data.results[0].Ddtext);
                      }
                    } else {
                      that
                        .getView()
      ...
      onMaterialFreightInputSuggestionSelect: function (oEvent, that) {
        var sTerm = oEvent.getParameter("selectedItem").getText(),
          sSelectedValue = sTerm,
          aFilters = [],
          Division = that
            .getView()
      ...
      // On change
      onMaterialFreightInputChange: function (oEvent, that) {
        var sTerm = oEvent.getParameter("value");
        if (!sTerm.includes(" ")) {
          var sSelectedValue = sTerm,
            aFilters = [],
            Division = that
              .getView()
              .getModel("JSONModelPayload")
